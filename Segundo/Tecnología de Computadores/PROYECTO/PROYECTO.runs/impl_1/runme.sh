...
HD_PWD='D:/Proyecto. LauraMartíndelOlmo.AdriánMuñozRodríguez/PROYECTO/PROYECTO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sintesis.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sintesis.tcl -notrace
