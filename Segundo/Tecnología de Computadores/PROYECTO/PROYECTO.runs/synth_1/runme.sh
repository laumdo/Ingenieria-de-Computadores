...
HD_PWD='D:/Proyecto. LauraMartíndelOlmo.AdriánMuñozRodríguez/PROYECTO/PROYECTO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sintesis.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sintesis.tcl
